...
id: IF-capability
kind: requirement
title: 归档：dsh/MANAGED.md「能力与边界」的旧绑定
status: superseded
summary: 旧绑定把图能力门槛写成经 Maintenance 的 maintenanceGraph 协议 2 与 graph-reference-actions-v1；MANAGED.md 重写、插件改为经 Core 会话数据端口工作后已失效。
sources:
