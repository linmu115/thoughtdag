...
| 插件 | 本批版本 | 必要依赖 |
|---|---|---|
| [Annotation Core](https://github.com/linmu115/dsh-annotation-core/releases/tag/v0.3.12-rc2.23) | 0.3.12-rc2.23 | DSH 宿主 |
| [ThoughtDAG](https://github.com/linmu115/thoughtdag/releases/tag/dsh-v0.4.14-rc2.19) | 0.4.14-rc2.19 | Core |
